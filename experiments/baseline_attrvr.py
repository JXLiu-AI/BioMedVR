...
if __name__ == "__main__":
    ...
    txt_emb_desattr = clip_attr_classifier(
        classes, model, "attributes/gpt3/" + args.dataset + "_des.json", num_attr=args.num_attr
    )
    txt_emb_distattr = clip_attr_classifier(
        classes, model, "attributes/gpt3/" + args.dataset + "_dist.json", num_attr=args.num_attr
    )
    ...
    for epoch in range(args.epoch):
        ...
        # Save log
        log_dir = "logs_attrvr_ViT-16shot-rebuttal"
